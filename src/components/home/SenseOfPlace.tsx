      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24 items-center">
        ...
        >
          ...
          <p className="text-[var(--color-muted)] leading-relaxed mb-6 text-balance">
            On the leafy Bithoor Road near the Ganga, Royal Forest Resort is a pocket of calm — lush forest-gardens and swaying palms, cottages that open directly to greenery, and one of Kanpur's largest swimming pools at its heart.
          </p>
          <p className="text-[var(--color-muted)] leading-relaxed mb-10 text-balance">
            Whether you're seeking a peaceful weekend staycation or a sprawling open-air venue for a destination wedding without leaving the city, your escape into nature begins here.
          </p>
